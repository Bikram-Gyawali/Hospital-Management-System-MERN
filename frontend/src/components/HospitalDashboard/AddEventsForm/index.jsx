            ...
            <ModalForm onSubmit = {handleFormSubmit}>
                <ModalBody>
                    <InputGroup>
                        ...
                        <Input type="text" id="eventName" fluid value={ eventName } onChange={handleEventNameChange} />
                    </InputGroup>
                    ...
                    <TwoColumnGroups>
                        <InputGroup>
                            ...
                            <br />
                            <Input type="date" id="eventDate" value={ date } onChange={handleEventDateChange} />
                        </InputGroup>
                        {/* <InputGroup>
                    ...
                    <InputGroup>
                        ...
                        <TextArea id="eventDescription" fluid value={ desc} onChange = {handleDescChange}/>
                    </InputGroup>
                </ModalBody>
                {
                    type === "add" ?
