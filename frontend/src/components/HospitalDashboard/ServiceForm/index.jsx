            ...
            <ModalForm onSubmit={handleSubmit}>
                <ModalBody>
                    <InputGroup>
                        ...
                        <Input type="text" id="serviceTopic" fluid value={topic} onChange={(e) => setTopic(e.target.value)} />
                    </InputGroup>
                    <InputGroup>
                        <Label htmlFor="serviceCharge">Service Charge</Label>
                        <Input type="number" id="serviceCharge" fluid value={charge} onChange={(e) => setCharge(e.target.value)} />
                    </InputGroup>
                    <InputGroup>
                        <Label htmlFor="serviceDesc">Speciality</Label>
                        <TextArea id="serviceDesc" fluid value={description} onChange={(e) => setDescription(e.target.value)} />
                    </InputGroup>
                </ModalBody>
                {
                    type === "add" ?
