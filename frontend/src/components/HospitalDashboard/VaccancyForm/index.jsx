            ...
            <ModalForm onSubmit={handleSubmit}>
                <ModalBody>
                    <InputGroup>
                        ...
                        <Input type="text" id="position" fluid value={position} onChange={(e) => setPosition(e.target.value)} />
                    </InputGroup>
                    <InputGroup>
                        <Label htmlFor="amount">Availiable Seats</Label>
                        <Input type="number" id="amount" fluid value={amount} onChange={(e) => setAmount(e.target.value)} />
                    </InputGroup>
                    <InputGroup>
                        <Label htmlFor="desc">Description</Label>
                        <TextArea id="desc" fluid value={desc} onChange={(e) => setDesc(e.target.value)} />
                    </InputGroup>
                </ModalBody>
