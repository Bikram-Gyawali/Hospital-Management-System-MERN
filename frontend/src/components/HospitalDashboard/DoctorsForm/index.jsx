...
const AddEvent = ({ open, setOpen, type }) => {
    ...
    return (
        <Modal setOpen={setOpen} open={open} >
            <ModalTitle>
                {type === "add" ? "Add Doctor" : "Update Doctor"}
            </ModalTitle>
                        ...
                        <ModalForm onSubmit = {handleSubmit}>
                            <ModalBody>
                                <InputGroup>
                                    ...
                                    <Input type="text" id="doctorName" fluid value = {name} onChange = {(e)=>setName(e.target.value)} />
                                </InputGroup>
                                <InputGroup>
                                    <Label htmlFor="doctorEmail">Doctor Email</Label>
                                    <Input type="email" id="doctorEmail" fluid value = {email} onChange = {(e)=>setEmail(e.target.value)} />
                                </InputGroup>
                                <InputGroup>
                                    <Label htmlFor="doctorExp">Experience</Label>
                                    <Input type="number" id="doctorExp" fluid value = {exp} onChange = {(e)=>setExp(e.target.value)} />
                                </InputGroup>
                                <InputGroup>
                                    <Label htmlFor="doctorSpecialities">Speciality</Label>
                                    <Input type="text" id="doctorSpecialities" fluid value = {spec} onChange = {(e)=>setSpec(e.target.value)} />
                                </InputGroup>
                                <InputGroup>
                                    <Label htmlFor="primaryNumber" >Primary Number</Label>
                                    <Input type="number" id="primaryNumber" fluid value = {contacts} onChange = {(e)=>setContacts(e.target.value)} />
                                </InputGroup>
                                <InputGroup>
                                    <Label htmlFor="graduatedFrom" >Graduated From</Label>
                                    <Input type="text" id="graduatedFrom" fluid value={graduatedFrom} onChange={(e) => setGraduatedFrom(e.target.value)} />
                                </InputGroup>
                            </ModalBody>
                            {
                                type === "add" ?
                        <Button type="submit" disabled={submitting}>Add Doctor</Button> :
                        <Button type="submit" disabled={submitting}>Update Doctor</Button>
                            }
