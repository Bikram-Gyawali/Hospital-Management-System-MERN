    ...
    return (
        <Modal setOpen={setOpen} open={open} >
            ...
            <ModalForm onSubmit = {handleSubmit}>
                <ModalBody>
                    <TwoColumnGroups>
                        <InputGroup>
                            ...
                            <Input type="number" id="icuRemaining" fluid value = {icu} onChange = {(e) => setIcu(e.target.value)} />
                        </InputGroup>
                        {/* <InputGroup>
                    ...
                    <TwoColumnGroups>
                        <InputGroup>
                            ...
                            <Input type="number" id="ventilatorsRemaining" fluid value = {ventilators} onChange = {(e) => setVentilators(e.target.value)} />
                        </InputGroup>
                        {/* <InputGroup>
                    ...
                    <TwoColumnGroups>
                        <InputGroup>
                            ...
                            <Input type="number" id="othersRemaining" fluid value={others} onChange={(e) => setOthers(e.target.value)} />
                        </InputGroup>
                        {/* <InputGroup>
                ...
                <Button type="submit" disabled = {submitting}>Update Beds</Button>
            </ModalForm>
        </Modal>
    )
}
